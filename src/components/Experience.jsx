...
const Experience = () => {
    return (
        <section id="experience" className="section-padding container text-center">
            <RevealOnScroll>
                <h2 className="section-title">The Villa Zuri Experience</h2>
                <p className="section-text">
                    Nestled on the pristine shores of the Kenyan coast, Villa Zuri is more than just a place to stay—it is a sanctuary for the soul.
